...
- [`mise tool-alias [-p --tool <TOOL>] [--no-header] <SUBCOMMAND>`](/cli/tool-alias.md)
...
- [`mise bootstrap dotfiles machines [-J --json]`](/cli/bootstrap/dotfiles/machines.md)
- [`mise bootstrap dotfiles origin [FLAGS] [SUBCOMMAND]`](/cli/bootstrap/dotfiles/origin.md)
...
- [`mise bootstrap dotfiles pull [FLAGS] [PATH]…`](/cli/bootstrap/dotfiles/pull.md)
...
- [`mise bootstrap dotfiles sync [--fetch-only] [--best-effort]`](/cli/bootstrap/dotfiles/sync.md)
...
- [`mise latest [-i --installed] [--minimum-release-age <MINIMUM_RELEASE_AGE>] <TOOL@VERSION>`](/cli/latest.md)
...
- [`mise packslip <SUBCOMMAND>`](/cli/packslip.md)
...
- [`mise deps [FLAGS] [PROVIDER] <SUBCOMMAND>`](/cli/deps.md)
...
- [`mise skills <SUBCOMMAND>`](/cli/skills.md)
- [`mise skills ls [-J --json]`](/cli/skills/ls.md)
- [`mise skills sync [FLAGS]`](/cli/skills/sync.md)
